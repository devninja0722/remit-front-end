...
const RemittanceItem = ({ item }: RemittanceItemProps) => {
  ...
  return (
    <>
      <div className="bg-white flex justify-between items-center px-3 py-2 text-sm lg:text-base !font-semibold text-dark-blue min-w-full w-fit cursor-pointer" onClick={() => setCollapsed(!collapsed)}>
      ...
      {!collapsed &&
        <div className="mx-3 overflow-auto">
          <div className="flex bg-gray/60 px-4 py-3 text-sm !font-semibold min-w-full w-fit items-center">
            <div className="flex flex-1">
          ...
          <div className="flex px-4 py-3 !font-semibold min-w-full w-fit items-center text-primary">
            <div className="flex flex-1">
