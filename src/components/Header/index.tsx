...
const AppBar = () => {
  ...
  return (
    <header className={classNames("z-[10001] flex-shrink-0 w-full text-sm md:text-base font-montserrat border-b border-stroke", ["signin", "signup", "country", "identity"].includes(routeTag) ? "!hidden" : "")}>
